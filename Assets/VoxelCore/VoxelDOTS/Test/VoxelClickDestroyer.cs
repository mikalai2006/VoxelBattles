...
//    private bool shootPressedThisFrame;
...
//        if (controls != null)
//        {
//            // 1. Отписываемся от события, чтобы избежать утечек памяти
//            controls.Player.Attack.performed -= OnAttackPerformed;

//            // 2. Уничтожаем сам инстанс управления
//            controls.Dispose();
//        }
//    }
